...
function test() {
    ...
    let vs2 = VideoSystem.getInstance("holaholahola");
    console.log("Primera vs con el nombre Prueba, nombre: " + vs.name);
    console.log("Segunda vs2 con el nombre holaholahola, nombre: " + vs2.name);
    //Asignamos nombre a la plataforma
    vs.name = "Plataforma VideoSystem";
    console.log("Uso de setter name, ahora el nombre es: " + vs.name);
    ...
    // Al hacer factory y por empaquetar por modulos , el test.js no tiene acceso a Production para probar la clase abstracta
    ...
    console.log("************ TESTEO PRODUCTION (Serie and Movie) ************");
